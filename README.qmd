...
the converter can build a global endpoint-node dictionary to keep node IDs
consistent across split boundaries.

- `global_node_prepass = "auto"` (default): enabled for split runs, disabled for `split_by = "none"`.
